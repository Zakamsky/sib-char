...
?>
				...
				<div class="row">
					<div class="foot">
						...
						<div class="foot-cell foot-doc"><a href="<?php echo get_page_link(14); ?>">Кухня</a><br>
										...
										<a href="<?php echo get_page_link(307); ?>">Вакансии</a><br>
										<a href="<?php echo get_page_link(308); ?>">Галерея</a>
    ...
    <script type="text/javascript" src="//w74422.yclients.com/widgetJS" charset="UTF-8"></script>
  <? wp_footer(); ?>
...
<div class="modalInner">
	<section class="box-modal">
		<div class="box-modal_close arcticmodal-close"><img src="/wp-content/themes/public/img/g-house/close.png"></div>
		<img src="/wp-content/uploads/2017/12/IVP_1910.jpg" class="innerCover">
		<div class="innerText">
			<h2>Подарочные часы</h2>
			<p>
				На весь сентябрь действует акция на посещение бани в будние дни.<br>
				Таежная: каждый 3-й час в подарок.<br>
				Горная и Озерная: каждый 4 час в подарок.<br><br>
				Акция действует с 01.09.2019 по 30.09.2019
			</p>

			<div class="textLinkCs">
				<a href="tel:+73833835030" onclick="yaCounter47949776.reachGoal('click-domik');ga('send', 'event', 'Попап', 'Забронировать');">ЗАБРОНИРОВАТЬ</a>
			</div>
			<div class="textLinkCbig">
				<a href="tel:+73833835030" onclick="yaCounter47949776.reachGoal('click-domik');ga('send', 'event', 'Попап', 'Позвонить');">+7 (383) 383-50-30</a>
			</div>
			<div class="arcticmodal-close box-modal_close-txt">закрыть</div>
		</div>
	</section>
</div>
<? */ ?>
...
<script>
    ...
    })(window, document, 'script', 'cloud.roistat.com', 'cb0ff7c74b333f89d6e8ec581a3c624b');
</script>
...
<script async type="bogus" class="js-whatsapp-message-container">Отправьте это сообщение, и после этого задайте вопрос. Номер вашего обращения:  {roistat_visit}</script>
<script async>
    (function() {
...
<script async type="text/javascript" >
    (function (d, w, c) {
        (w[c] = w[c] || []).push(function() {
            try {
                w.yaCounter47949776 = new Ya.Metrika({
                    id:47949776,
                    clickmap:true,
                    trackLinks:true,
...
<noscript><div><img src="https://mc.yandex.ru/watch/47949776" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
<!-- /Yandex.Metrika counter -->


<!-- Google Tag Manager (noscript) -->
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-M36N7FR"
