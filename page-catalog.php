...
<?
$banyaID = 1;
if (get_the_ID() == 395) $banyaID = 2;
if (get_the_ID() == 396) $banyaID = 3;
?>
				...
				<div class="row">
					...
					<ul class="single-row">
						<li class="single-column">
							...
							<div class="image">
								<img src="/wp-content/themes/public/img/files/2.jpg" alt="<?php echo esc_attr($image['alt'])?: "Наши бани"; ?>">
							</div>
						</li>
						<li class="single-column">
							<div class="content">
							...
							<div class="image">
								<img src="/wp-content/themes/public/img/files/3.jpg" alt="<?php echo esc_attr($image['alt'])?: "Наши бани"; ?>">
							</div>
						</li>
						<li class="single-column">
							<div class="content">
							...
							<div class="image">
								<img src="/wp-content/themes/public/img/files/4.jpg" alt="<?php echo esc_attr($image['alt'])?: "Наши бани"; ?>">
							</div>
						</li>
					</ul>
					*/
